  ...
  <>
    ...
    <MainLayout>
      <div className="filters-wrapper">
        <h2>Problems Dashboard By Project</h2>
...
console.log(envType);
        ...
        >
          ...
          return (
          <>
          <div key={name + id} className="content-wrapper">
            {environments &&
                    ...
                    >
                      ...
                      {environments && environments.map(environment => (
                        <div className="environment-wrapper">
                          ...
                          <ProblemsByProject key={environment.id} problems={environment.problems || []}/>
                        </div>
                      ))}
                    </Accordion>
                </div>
            ...
            <style jsx>{`
              .content-wrapper {
                ...
                .content {
                  background: #fff;
                  margin: 1em calc((100vw / 16) * 1);
                  @media ${bp.wideUp} {
                    margin: 1em calc((100vw / 16) * 2);
                  }
                  @media ${bp.extraWideUp} {
                    margin: 1em calc((100vw / 16) * 3);
                  }
